                  ...
                  <div className="col-md-2 col-sm-3 col-xs-6">
                    ...
                    <ul id="top-menu" className="dropdown-content top-menu-sty">
                      <li>
                        ...
                        <Link to ="setting.js" className="waves-effect"><i className="fa fa-cogs" aria-hidden="true" />Admin Setting</Link>
                        
                      </li>
                      <li>
                        
                        <Link to ={"listingAll.js"} className="waves-effect"><i className="fa fa-list-ul" aria-hidden="true" /> Listings</Link>
