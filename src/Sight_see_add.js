...
export default class Sight_see_add extends Component{
  render() {
    return (
      <div>
            ...
            <div className="sb2-2">
              <div className="sb2-2-2">
                <ul>
                  ...
                  <li className="active-bre"><a href="#"> Add New Sight Seeing</a>
                  </li>
                ...
                <div className="box-inn-sp">
                  ...
                  <div className="bor">
                    <form>
                      ...
                      <div className="row">
                        <div className="input-field col s12">
                          <input id="ss-auth" type="text" className="validate" />
                          <label htmlFor="ss-auth">Author Name</label>
                        </div>
                      </div>
                      <div className="row">
                        <div className="input-field col s12">
