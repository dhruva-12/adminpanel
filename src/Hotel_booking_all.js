...
var Hotel_booking_all = React.createClass({
  render: function() {
    return (
      <div>
              ...
              <div className="sb2-13">
                <ul className="collapsible" data-collapsible="accordion">
                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header active"><i className="fa fa-ticket" aria-hidden="true" /> Booking &amp; Enquiry</a>
                    <div className="collapsible-body left-sub-menu">
                      <ul>
                        <li><a href="hotel-booking-all.html" className="menu-active">Hotel</a>
                        </li>
            ...
            <div className="sb2-2">
              <div className="sb2-2-2">
                <ul>
                  ...
                  <li className="active-bre"><a href="#"> Hotel Booking Enquiry</a>
                  </li>
                </ul>
              </div>
