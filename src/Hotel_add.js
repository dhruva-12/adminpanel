                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header active"><i className="fa fa-h-square" aria-hidden="true" /> Hotels</a>
                    <div className="collapsible-body left-sub-menu">
                      <ul>
                        ...
                        <li><a href="hotel-add.html" className="menu-active">Add New Hotel</a>
                        </li>
            ...
            <div className="sb2-2">
              <div className="sb2-2-2">
                <ul>
                  ...
                  <li className="active-bre"><a href="#"> Add Hotel</a>
                  </li>
                </ul>
              </div>
                  ...
                  <div id="menu1" className="tab-pane fade">
                    ...
                    <div className="bor">
                      <form>
                        ...
                        <div className="row">
                          <div className="input-field col s12">
                            <textarea id="textarea3" className="materialize-textarea" defaultValue={""} />
                            <label htmlFor="textarea3">Listing Descriptions:</label>
                          </div>
                        </div>
                        <div className="row">
                          <div className="input-field col s12">
