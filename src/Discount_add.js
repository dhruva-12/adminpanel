            ...
            <div className="sb2-1">
              ...
              <div className="sb2-13">
                <ul className="collapsible" data-collapsible="accordion">
                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header active"><i className="fa fa-usd" aria-hidden="true" /> Discounts</a>
                    <div className="collapsible-body left-sub-menu">
                      <ul>
                        <li><a href="discount.html">All Discounts</a>
                        </li>
                        <li><a href="discount-add.html" className="menu-active">Add New Discounts</a>
                        </li>
                      </ul>
                    </div>
                  </li>
            ...
            <div className="sb2-2">
              <div className="sb2-2-2">
                <ul>
                  ...
                  <li className="active-bre"><a href="#"> Add Discount</a>
                  </li>
                    ...
                    <form>
                      <div className="row">
                        <div className="input-field col s12">
                          ...
                          <label htmlFor="list-title">Discount Name</label>
                        </div>
                        <div className="input-field col s12">
                          <input id="post-auth" type="text" defaultValue className="validate" />
                          <label htmlFor="post-auth">Discount Price</label>
                        </div>
                        <div className="input-field col s12">
