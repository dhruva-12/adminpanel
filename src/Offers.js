            ...
            <div className="sb2-1">
              ...
              <div className="sb2-13">
                <ul className="collapsible" data-collapsible="accordion">
                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header active"><i className="fa fa-tags" aria-hidden="true" /> Offers</a>
                    <div className="collapsible-body left-sub-menu">
                      <ul>
                        <li><a href="offers.html" className="menu-active">All Offers</a>
                        </li>
