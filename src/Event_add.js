...
var Event_add = React.createClass({
  render: function() {
    return (
      <div>
            ...
            <div className="sb2-1">
              ...
              <div className="sb2-13">
                <ul className="collapsible" data-collapsible="accordion">
                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header active"><i className="fa fa-calendar-o" aria-hidden="true" /> Events</a>
                    <div className="collapsible-body left-sub-menu">
                      <ul>
                        <li><a href="event-all.html">All Events</a>
                        </li>
                        <li><a href="event-add.html" className="menu-active">Add New Event</a>
                        </li>
                      </ul>
                    </div>
                  </li>
