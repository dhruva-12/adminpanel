...
var Event_edit = React.createClass({
  render: function() {
    return (
      <div>
                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header active"><i className="fa fa-ticket" aria-hidden="true" /> Booking &amp; Enquiry</a>
                    <div className="collapsible-body left-sub-menu">
                      <ul>
                        ...
                        <li><a href="event-booking-all.html" className="menu-active">Events</a>
                        </li>
                      </ul>
                    </div>
                  </li>
            ...
            <div className="sb2-2">
              <div className="sb2-2-2">
                <ul>
                  ...
                  <li className="active-bre"><a href="#"> Event Edit</a>
                  </li>
                    ...
                    <form>
                      <div className="row">
                        <div className="input-field col s12">
                          <input id="list-title" type="text" defaultValue="Event Name" className="validate" />
