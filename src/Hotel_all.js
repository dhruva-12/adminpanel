...
var Hotel_all = React.createClass({
  render: function() {
    return (
      <div>
            ...
            <div className="sb2-1">
              ...
              <div className="sb2-13">
                <ul className="collapsible" data-collapsible="accordion">
                  ...
                  <li><a href="javascript:void(0)" className="collapsible-header"><i className="fa fa-list-ul" aria-hidden="true" /> Listings</a>
                          ...
                          <table className="table table-hover">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>Australia</td>
                                <td>
                                  <a href="hotel-edit.html"><i className="fa fa-eye" aria-hidden="true" /></a>
                                </td>
                                <td>
                                  <a href="hotel-edit.html"><i className="fa fa-pencil-square-o" aria-hidden="true" /></a>
                                </td>
                                <td>
